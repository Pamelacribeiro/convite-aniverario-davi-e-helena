      ...
      <div className="container mx-auto px-4 grid md:grid-cols-2 gap-8 md:gap-12 items-center relative z-10">
        <div className="order-2 md:order-1 text-center md:text-left">
          ...
          <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-4 text-blaze-dark">
            <span className="block">Davi e Helena fazem</span> 
            <span className="text-blaze-red inline-block transform -rotate-1">aniversário!</span>
          </h1>
          
          <p className="text-lg md:text-xl mb-6 text-blaze-dark/80 max-w-xl">
            Ei, pessoal! A Carreta da Alegria já ligou os motores e o som está no talo! Estamos passando aqui para convidar todo mundo para a festa dos irmãos Davi e Helena! Venham embarcar nessa aventura cheia de passos de dança, acrobacias e muita diversão com os personagens mais animados!
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center md:justify-start mb-8">
            <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-lg px-4 py-3 shadow-sm">
              ...
              <span className="font-medium">Sábado, 13 de junho de 2026</span>
            </div>
            
            <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-lg px-4 py-3 shadow-sm">
              <Clock className="text-blaze-red h-5 w-5 mr-2" />
              <span className="font-medium">A partir das 17h</span>
            </div>
          </div>
          ...
          <div className="flex items-center bg-white/80 backdrop-blur-sm rounded-lg px-4 py-3 shadow-sm inline-block mb-8">
            ...
            <span className="font-medium">Espaço Sonhos em Festa, próximo ao colégio máximus</span>
          </div>
          ...
          <div className="md:hidden w-full mt-16">
            <div className="photo-frame-stack relative z-20">
              <div className="photo-frame z-20 transform rotate-3 shadow-xl bg-transparent p-2">
