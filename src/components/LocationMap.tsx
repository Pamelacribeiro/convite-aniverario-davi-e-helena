...
const LocationMap = () => {
  const address = "Rua Doutor Nestor Luiz Pinheiro, 145, Alvorada";
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-blaze-dark/70 max-w-2xl mx-auto">
            O Espaço Sonhos em festas está pronto para receber a festa mais animada do ano!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          <div className="glass-card rounded-lg p-6 shadow-lg">
            <div className="mb-6">
              <h3 className="text-2xl font-bold mb-4 text-blaze-dark">Espaço Sonhos em Festa</h3>
              <p className="text-blaze-dark/70 mb-6">
                Um espaço amplo e seguro, decorado especialmente para o tema Carreta da Alegria, 
              ...
              <div className="flex flex-col space-y-3 mb-6">
                <div className="flex items-start">
                  ...
                  <span className="font-medium">
                    Rua Dr Nestor Luiz Pinheiro, 195 – Alvorada, Cristais
                  </span>
                </div>
              </div>
