...
const initialMessages = [
  {
    id: 1,
    author: 'Pâm',
    message: 'Parabéns, Davi e Helena! Que seu dia seja cheio de alegria e diversão! Mal posso esperar para celebrar com você.',
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-blaze-dark/70 max-w-2xl mx-auto">
            Deixe uma mensagem especial para Davi e Helena! Eles vai adorar ler todas as mensagens de carinho.
          </p>
        </div>
