        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-center">
          ...
          <div className="md:order-1 animate-slide-up opacity-0" style={{ animationDelay: '0s' }}>
            ...
            */}
            ...
            <div className="glass-card rounded-lg p-8 shadow-lg min-h-64">
              <h3 className="text-xl font-bold mb-4 text-blaze-dark">Também pode confirmar por WhatsApp</h3>
              <p className="text-blaze-dark/70 mb-8">
                Se preferir, também pode confirmar sua presença enviando uma mensagem diretamente para:
              </p>
              
              <button
                onClick={openWhatsApp}
                className="button-3d w-full bg-green-500 hover:bg-green-600 text-white font-bold rounded-full py-3 px-6 flex items-center justify-center space-x-2 mb-6"
              >
              ...
              <div className="text-center mt-4">
                <p className="font-medium text-blaze-dark">35 991059061</p>
              </div>
            </div>
          </div>
        </div>
