  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: "Obrigado por confirmar sua presença na festa dos irmãos Davi e Helena!",
      });
      ...
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-blaze-dark/70 max-w-2xl mx-auto">
            Por favor, confirme aqui se irá na festa!
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto items-center">
          <div className="glass-card rounded-lg p-8 shadow-lg md:order-2 animate-slide-up opacity-0" style={{ animationDelay: '0.2s' }}>
            {!isSubmitted ? (
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  <label htmlFor="date" className="block mb-2 font-medium text-blaze-dark">
                    Data (opcional)
                  </label>
                  <input
                    type="date"
              ...
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-6">
                  Muito obrigado por confirmar sua presença na festa!
                </p>
                <button
          ...
          <div className="md:order-1 animate-slide-up opacity-0" style={{ animationDelay: '0s' }}>
            ...
            */}
            ...
            <div className="glass-card rounded-lg p-12 shadow-lg min-h-80">
              <h3 className="text-xl font-bold mb-6 text-blaze-dark">Também pode confirmar por WhatsApp</h3>
              <p className="text-blaze-dark/70 mb-12">
                Se preferir, também pode confirmar sua presença enviando uma mensagem diretamente para:
              </p>
              
              <button
                onClick={openWhatsApp}
                className="button-3d w-full bg-green-500 hover:bg-green-600 text-white font-bold rounded-full py-4 px-8 flex items-center justify-center space-x-2 mb-8"
              >
              ...
              <div className="text-center mt-8">
                <p className="text-lg font-bold text-blaze-dark">35 991059061</p>
              </div>
            </div>
          </div>
        </div>
