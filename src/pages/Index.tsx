  ...
  return (
    <div className="min-h-screen relative">
      ...
      <main>
        ...
        {/* Photo memory section for Helena e Davi */}
                ...
                <div className="flex flex-col md:flex-row gap-8 items-center">
                  ...
                  <div className="w-full md:w-2/3 text-center md:text-left">
                    <h2 className="text-3xl font-bold mb-4 text-blaze-dark">
                      Davi e Helena estão fazendo <span className="text-blaze-red">4 e 6 anos</span>!
                    </h2>
                    <p className="text-lg text-blaze-dark/70 mb-6">
                      A diversão vai começar e o ponto de encontro já está marcado! A Helena e o Davi convidam você para embarcar na Carreta da Alegria mais animada de todas. Prepare-se para muita música, passos de dança e uma energia sem fim. Venha celebrar esse dia inesquecível com a gente!
                    </p>
      ...
      <footer className="bg-blaze-dark text-white py-12">
        <div className="container mx-auto px-4">
          <div className="text-center">
            <h2 className="text-3xl font-bold mb-6">Davi e Helena fazem aniversário!</h2>
            ...
            <div className="flex flex-col md:flex-row justify-center items-center gap-6 mb-10">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span>Bairro Alvorada</span>
              </div>
            </div>
            
            <div className="text-white/60 text-sm">
              &copy; {new Date().getFullYear()} - Festa de aniversário do Davi e da Helena
            </div>
          </div>
        </div>
      </footer>
